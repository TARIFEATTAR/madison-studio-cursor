...
## Option 1: Use Complete Training Doc (EASIEST) ✅

**File:** `MADISON_AGENT_TRAINING_COMPLETE.md`

**What it contains:**
- ✅ All 8 author profiles (summaries)
- ✅ All 3 brand authorities (summaries)
- ✅ All principles and philosophy
- ✅ Quality standards
- ✅ Forbidden phrases
- ✅ Best practices
- ✅ Everything you need
...
## Option 2: Use Individual Files (MORE DETAILED) 🔧
...
|------|------------|---------|
| `MADISON_AGENT_TRAINING_COMPLETE.md` | Complete training reference | ✅ **Paste into Emergent** |
...
**For Emergent:**
1. ✅ Use `MADISON_AGENT_TRAINING_COMPLETE.md` as your main training doc
2. ✅ Add `madison_system_config_export.json` for exact config
3. ✅ Optionally add individual files if you need more detail
