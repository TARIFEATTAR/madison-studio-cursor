...
const PRODUCTS = [
  { name: "Aged Mysore Sandalwood", collection: "Purity Collection", scentFamily: "Woody" },
  { name: "Aseel", collection: "Cadence Collection", scentFamily: "Fresh" },
  { name: "Black Musk", collection: "Cadence Collection", scentFamily: "Warm" },
  { name: "Black Oudh", collection: "Cadence Collection", scentFamily: "Woody" },
  { name: "China Rain", collection: "Cadence Collection", scentFamily: "Fresh" },
  { name: "Egyptian Musk", collection: "Cadence Collection", scentFamily: "Warm" },
  { name: "Floral Dew", collection: "Cadence Collection", scentFamily: "Fresh" },
  { name: "Frankincense & Myrrh", collection: "Cadence Collection", scentFamily: "Woody" },
  { name: "Granada Amber", collection: "Cadence Collection", scentFamily: "Warm" },
  { name: "Himalayan Musk", collection: "Cadence Collection", scentFamily: "Warm" },
  { name: "Hojari Frankincense & Yemeni Myrrh", collection: "Reserve Collection", scentFamily: "Woody" },
  { name: "Honey Oudh", collection: "Cadence Collection", scentFamily: "Warm" },
  { name: "Indonesian Patchouli", collection: "Purity Collection", scentFamily: "Woody" },
  { name: "Jannatul Firdaus", collection: "Cadence Collection", scentFamily: "Floral" },
  { name: "Kush", collection: "Cadence Collection", scentFamily: "Woody" },
  { name: "Majmua Attar", collection: "Cadence Collection", scentFamily: "Floral" },
  { name: "Musk Tahara", collection: "Cadence Collection", scentFamily: "Warm" },
  { name: "Red Musk", collection: "Cadence Collection", scentFamily: "Warm" },
  { name: "Royal Green Frankincense", collection: "Sacred Space", scentFamily: "Woody" },
  { name: "Royal Tahara", collection: "Cadence Collection", scentFamily: "Warm" },
  { name: "Sandalwood Rose", collection: "Cadence Collection", scentFamily: "Floral" },
  { name: "Seville", collection: "Cadence Collection", scentFamily: "Woody" },
  { name: "Turkish Rose", collection: "Cadence Collection", scentFamily: "Floral" },
  { name: "Vanilla Sands", collection: "Cadence Collection", scentFamily: "Warm" },
  { name: "White Amber", collection: "Cadence Collection", scentFamily: "Warm" },
