...
const ScriptoraLoadingAnimation = () => {
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-[#F5F1E8] overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-2xl px-8">
        ...
        <div className="mb-8 flex items-center justify-center">
          <div className="relative w-20 h-20">
            ...
            >
              ...
              <circle cx="50" cy="15" r="2" fill="#C9A863" opacity="0.7" />
              <circle cx="85" cy="50" r="2" fill="#C9A863" opacity="0.7" />
              <circle cx="50" cy="85" r="2" fill="#C9A863" opacity="0.7" />
              <circle cx="15" cy="50" r="2" fill="#C9A863" opacity="0.7" />
            </svg>
          </div>
        </div>
        ...
        <div className="min-h-[32px] mb-8">
          <p 
            key={currentPhase}
            className="text-[#A8A39E] italic text-lg animate-fade-in"
            ...
            >
              <svg width="40" height="50" viewBox="0 0 40 50" fill="none">
                <rect 
                  ...
                  rx="2"
                />
                <line x1="8" y1="12" x2="32" y2="12" stroke="#B8956A" strokeWidth="1" opacity="0.3" />
                <line x1="8" y1="18" x2="32" y2="18" stroke="#B8956A" strokeWidth="1" opacity="0.3" />
                <line x1="8" y1="24" x2="28" y2="24" stroke="#B8956A" strokeWidth="1" opacity="0.3" />
              </svg>
            </div>
          ))}
        </div>
...
export default ScriptoraLoadingAnimation;
