            ...
            >
                ...
                <div className="min-h-[280px] py-4">
                        ...
                        <div className="space-y-4 animate-in fade-in-0 slide-in-from-right-4 duration-300">
                            ...
                            <div className="mt-8 p-4 rounded-lg bg-accent/10 border border-border/20">
                                <p className="text-sm text-foreground/80">
                                    <strong className="text-foreground">Pro tip:</strong> Madison learns your preferences over time to provide increasingly personalized content suggestions.
                                </p>
                            </div>
                        </div>
                    )}
                    ...
                    {step === 3 && (
                        <div className="space-y-4 animate-in fade-in-0 slide-in-from-right-4 duration-300">
                            <div className="space-y-2">
                                <Label htmlFor="websiteUrl" className="text-foreground text-base">
                                    Website URL <span className="text-muted-foreground text-sm">(optional but recommended)</span>
                                </Label>
                                <Input
                                    id="websiteUrl"
