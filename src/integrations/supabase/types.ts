  ...
  public: {
    ...
    Functions: {
      ...
      get_user_team_role: {
        ...
        Returns: Database["public"]["Enums"]["team_role"] | null
      }
      get_role_capabilities: {
        Args: { _team_role: Database["public"]["Enums"]["team_role"] }
        Returns: {
          section_info: string
          section_media: string
          section_formulation: string
          section_ingredients: string
          section_compliance: string
          section_packaging: string
          section_marketing: string
          section_analytics: string
    ...
    Enums: {
      ...
      team_role: "founder" | "creative" | "compliance" | "marketing" | "operations" | "finance" | "general"
    }
    CompositeTypes: {
      [_ in never]: never
    }
